...
class VoronoiDiagram:
    ...
    def __garbage(self, t_point_list):
        ...
        if len(t_point_list) <= 1:
            ...
            self.polyedge_list.append(
                self.__p_bisector(t_point_list[0], t_point_list[1]))
    ...
    def __3p_force(self, point_list):
        s_index = 0
        dis_list = list()
        ...
        if circumcenter:
            ...
            self.__writeback_record('n', point_list, l_p_bisector, r_p_bisector, m_p_bisector)
        
        else:
            write_back()
            self.__writeback_record('n', point_list, l_p_bisector, r_p_bisector)
    ...
    def __p_bisector(self, a, b):
        ...
        start_p = [midpoint[0] - vector_extend[0], midpoint[1] - vector_extend[1]]
        end_p = [midpoint[0] + vector_extend[0], midpoint[1] + vector_extend[1]]
